...
set shortmess=aoO
badd +8 coursegrapher.rb
badd +1 views/index.haml
badd +1 views/layout.haml
badd +1 public/js/chart.js
badd +1 ../Dropbox/pcr/templates/majors.html
badd +1 get_data.rb
badd +1 models.rb
badd +1 ../Dropbox/pcr/templates/base.html
badd +1 public/css/style.css
badd +1 ../Dropbox/pcr/media/style.css
badd +22 ~/.vimrc
args coursegrapher.rb
...
silent! normal! zE
let s:l = 6 - ((0 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
6
normal! 02l
tabedit coursegrapher.rb
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
16
normal! 08l
tabedit ../Dropbox/pcr/media/style.css
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 42 - ((4 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
...
1
normal! 0
tabedit ../Dropbox/pcr/templates/majors.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 85 - ((45 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
85
normal! 0
tabedit ../Dropbox/pcr/templates/base.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 64 - ((6 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
